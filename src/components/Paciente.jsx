...
const Paciente = ({paciente}) => {
  ...
  return (
    <div className="mx-5 my-10 bg-whiter shadow-md px-5 py-10 rounded">
        ...
        <p className="font-bold uppercase text-indigo-800 my-2">Id: {''}
            <span className="font-normal normal-case text-black">{_id}</span>
        </p>
        <div className="flex justify-between my-5">
            <button
                type="button"
                className="py-2 px-10 text-white bg-indigo-600 hover:bg-indigo-700 uppercase font-bold rounded-lg"
            ...
            <button
                type="button"
                className="py-2 px-10 text-white bg-red-600 hover:bg-red-700 uppercase font-bold rounded-lg"
